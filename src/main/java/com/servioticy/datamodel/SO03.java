...
public class SO03 {
	...
	String name;
	String description;
	LinkedHashMap<String, SOStream03> streams;
...
//	LinkedHashMap<String, String> links;
	 ...
	 * @return the streams
	 */
	public LinkedHashMap<String, SOStream03> getStreams() {
		return streams;
	}
	/**
	 * @param streams the streams to set
	 */
	public void setStreams(LinkedHashMap<String, SOStream03> streams) {
